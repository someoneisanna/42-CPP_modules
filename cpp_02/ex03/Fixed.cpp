...
/*   Updated: 2024/06/12 13:53:22 by ataboada         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed::Fixed(const int n) { this->_rawBits = n << this->_fraBits; }
Fixed::Fixed(const float n) { this->_rawBits = roundf(n * (1 << this->_fraBits)); }
Fixed::~Fixed(void) {}
...
float	Fixed::toFloat(void) const { return ((float)this->_rawBits / (1 << this->_fraBits)); }
int		Fixed::toInt(void) const { return (this->_rawBits >> this->_fraBits); }
...
bool Fixed::operator>(const Fixed &src) const { return (this->_rawBits > src.getRawBits()); }
bool Fixed::operator<(const Fixed &src) const { return (this->_rawBits < src.getRawBits()); }
bool Fixed::operator>=(const Fixed &src) const { return (this->_rawBits >= src.getRawBits()); }
bool Fixed::operator<=(const Fixed &src) const { return (this->_rawBits <= src.getRawBits()); }
bool Fixed::operator==(const Fixed &src) const { return (this->_rawBits == src.getRawBits()); }
