...
void Bureaucrat::signForm(AForm &aform)
{
	if (aform.getSigned() == true)
		std::cout << GREEN << this->_name << " signed " << aform.getName() << RESET << std::endl;
	else
		std::cout << PINK << this->_name << " couldn't sign " << aform.getName()
...
{
	aform.execute(*this);
	std::cout << CYAN << this->_name << " executed " << aform.getName() << RESET << std::endl;
}
